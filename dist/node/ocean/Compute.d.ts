...
export declare class Compute extends Instantiable {
    ...
    status(consumerAccount: Account, did?: string, ddo?: DDO, service?: ServiceCompute, jobId?: string, txId?: string, sign?: boolean): Promise<ComputeJob[]>;
    ...
    result(consumerAccount: Account, asset: DDO | string, jobId: string): Promise<ComputeJob>;
